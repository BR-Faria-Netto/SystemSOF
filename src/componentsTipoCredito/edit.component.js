...
export default class Edit extends Component {
  ...
  componentDidMount() {
      axios.get(serverapi.name+'tipocreditos/edit/'+this.props.match.params.id)
          .then(response => {
              this.setState({ 
  ...
  onSubmit(e) {
    ...
    axios.post(serverapi.name+'tipocreditos/update/'+this.props.match.params.id, obj)
  ...
  render() {
    ...
    return (
        ...
        <div id='tipo' style={{ marginTop: 10 }}>
            <h3 align="center">Alteração do Tipo de Credito</h3>
