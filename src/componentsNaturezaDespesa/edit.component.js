...
export default class Edit extends Component {
  ...
  componentDidMount() {
      axios.get(serverapi.name+'naturezadespesas/edit/'+this.props.match.params.id)
          .then(response => {
              this.setState({ 
  ...
  onSubmit(e) {
    ...
    axios.post(serverapi.name+'naturezadespesas/update/'+this.props.match.params.id, obj)
