...
export default class Edit extends Component {
  ...
  componentDidMount() {
      axios.get('http://localhost:4000/naturezadespesas/edit/'+this.props.match.params.id)
          .then(response => {
              this.setState({ 
  ...
  onSubmit(e) {
    ...
    axios.post('http://localhost:4000/naturezadespesas/update/'+this.props.match.params.id, obj)
  ...
  render() {
    return (
        <div style={{ marginTop: 10 }}>
            <h3 align="center">Alteração da Natureza de Despesa</h3>
