...
export default class Edit extends Component {
  ...
  componentDidMount() {
      axios.get('http://localhost:4000/tipolicitacoes/edit/'+this.props.match.params.id)
          .then(response => {
              this.setState({ 
  ...
  onSubmit(e) {
    ...
    axios.post('http://localhost:4000/tipolicitacoes/update/'+this.props.match.params.id, obj)
  ...
  render() {
    return (
        <div style={{ marginTop: 10 }}>
            <h3 align="center">Alteração do Tipo de Licitação</h3>
