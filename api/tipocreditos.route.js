...
const tipocreditosRoute = express.Router();
// Require Business model in our routes module
let baseServer = require('./tipocreditos.model');

// Defined store route
tipocreditosRoute.route('/add').post(function (req, res) {
...
tipocreditosRoute.route('/').get(function (req, res) {
...
// Defined edit route
tipocreditosRoute.route('/edit/:id').get(function (req, res) {
...
tipocreditosRoute.route('/update/:id').post(function (req, res) {
...
tipocreditosRoute.route('/delete/:id').get(function (req, res) {
...
module.exports = tipocreditosRoute;
