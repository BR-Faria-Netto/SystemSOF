...
const unidgestorasRoute = express.Router();
// Require Business model in our routes module
let baseServer = require('./unidgestoras.model');

// Defined store route
unidgestorasRoute.route('/add').post(function (req, res) {
...
unidgestorasRoute.route('/').get(function (req, res) {
...
// Defined edit route
unidgestorasRoute.route('/edit/:id').get(function (req, res) {
...
unidgestorasRoute.route('/update/:id').post(function (req, res) {
...
unidgestorasRoute.route('/delete/:id').get(function (req, res) {
...
module.exports = unidgestorasRoute;
